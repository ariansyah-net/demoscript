    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          ...
          <ul class="list-unstyled" style="list-style-type:square; color:#ccc;">
            <li><a href="" class="text-white">Sitemap</a></li>
            <li><a href="" class="text-white">Privacy Policy</a></li>
            <li><a href="" class="text-white">Term of Service</a></li>
            <li><a href="" class="text-white">Contact Us</a></li>
            <li><a href="" class="text-white">Download this app</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container d-flex justify-content-between">
      <a href="<?= base_url() ?>" class="navbar-brand d-flex align-items-center">
        <i class="fab fa-accusoft"></i> &nbsp; <strong>Ariansyah.Net</strong>
      </a>
