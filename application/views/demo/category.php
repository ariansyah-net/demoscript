  ...
  <?php
             foreach ($ar->result_array() as $dd){
               ...
               echo "<div class='card' style='width: 22rem; margin: 10px;''>";
                 if ($dd['content_img'] == ''){
                   echo "<a href='".base_url()."/$dd[content_slug]'>
                   <img src='".base_url()."asset/img/noimage.png' class='card-img-top' alt='$dd[category_name]' >
                   </a>
                   ";
                 }else{
                   echo "<a href='".base_url()."tutorial/$dd[content_slug]'>
                   <img src='".base_url()."asset/img/$dd[content_img]' class='card-img-top' alt='$dd[category_name]'>
                   </a>";
                 }
                 echo "
                  <div class='card-body'>
                   <h5 class='card-title'><a href='".base_url()."$dd[content_slug]'>$dd[content_title]</a></h5>
