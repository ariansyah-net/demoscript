...
<div class="mr-5"></div>
  ...
  <div class="form-group">
    ...
    <?= form_textarea('d', '', array('class'=> 'form-control', 'placeholder' => 'write something..', 'required' => 'required')) ?>
  </div>

  <div class="form-group">
    <?php echo $img; ?><div class='p-2'></div>
    <?= form_input('captcha', '', array('class' => 'form-control', 'required' => 'required')) ?>
